...
$possible_plugin_locations = array(
	...
	'C:\MAMP\htdocs\cours_wordpress\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://127.0.0.1/cours_wordpress/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\MAMP\htdocs\cours_wordpress\wp-content\plugins\wp-optimize\cache/extensions');
}
